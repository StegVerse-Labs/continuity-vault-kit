...
current_focus: complete the automatic 0.1.3 publication cycle using step-level eligibility, durable outcome receipts, and bounded self-recovery
known_gaps:
...
completed_recently:
  ...
  - Moved publication eligibility out of the job-level predicate and into a normal gate step using source conclusion plus pull-request association
...
next_steps:
  ...
  - Allow the corrected workflow chain to publish the substantive Unreleased state as the next verified patch release
...
last_reviewed_utc: 2026-07-14T15:20:00Z
